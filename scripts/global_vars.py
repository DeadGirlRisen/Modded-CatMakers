...
eye_colors = bidict( {'YELLOW': "Yellow", 'AMBER': "Amber", 'HAZEL': "Hazel", 'PALEGREEN': "Pale Green",
                      ...
                      'SILVER': "Silver", 'ROSE': "Rose", 'ALGAE': "Algae", 'SEAFOAM': "Seafoam",
                      'LIGHT FLAME': "Light Flame", 'CLOUDY': "Cloudy", 'RED': "Red", 'TURQUOISE': "Turquoise",
                      'SWAMP': "Swamp", 'RAINY': "Rainy", 'AQUAMARINE': "Aquamarine", 'EARTH': "Earth",
                      'PUMPKIN': "Pumpkin", 'LILAC': "Lilac",'PERIWINKLE': "Periwinkle", 'VIOLET': "Violet",
                      'POND': "Pond", 'DIRT': "Dirt", 'BROWN': "Brown",
                      'CEDAR': "Cedar", 'CHRISTMAS': "Christmas", 'COTTON CANDY': "Cotton Candy", 'DARK PINE': "Dark Pine",
                      'FALL': "Fall", 'FOREST FIRE': "Forest Fire", 'GOLD MOON': "Gold Moon",
                      'HALLOWEEN': "Halloween", 'LOBELIA': "Lobelia", 'MIDNIGHT': "Midnight", 'MOONSTONE': "Moonstone",
                      'OXIDIZED': "Oxidized", 'SNOW': "Snow", 'BERRY BANANA': "Berry Banana", 'DAWN SKY': "Dawn Sky", 'TWILIGHT SKY': "Twilight Sky",
                      'WORMY': "Wormy", 'BLUE HAZEL': "Blue Hazel", 'THUNDERBOLT': "Thunderbolt", 'VOLCANO':"Volcano", 'SEASHELL': "Seashell", 'PARADOX': "Paradox",
                      'DAWN SKY': "Dawn Sky", 'TWILIGHT SKY': "Twilight Sky", 'THUNDERBOLT': "Thunderbolt", 'VOLCANO': "Volcano",
                      'CURSE': "Curse", 'BLESSING': "Blessing" })
